...
namespace EventSharedExpenseTracker.MvC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser() { CustomUserName = Input.CustomUserName, Email = Input.Email };
                //var user = CreateUser();
